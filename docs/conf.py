...
latex_documents = [
  ('index', 'UTide.tex', 'UTide Documentation',
   'Dan Codiga, Wesley Bowman, and contributors', 'manual'),
]
...
man_pages = [
    ('index', 'utide', 'UTide Documentation',
     ['Dan Codiga, Wesley Bowman, and contributors'], 1)
]
...
texinfo_documents = [
  ('index', 'UTide', 'UTide Documentation',
   'Dan Codiga, Wesley Bowman, and contributors', 'UTide', 'One line description of project.',
   'Miscellaneous'),
]
